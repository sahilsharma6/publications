...
/* ── Fetch categories that have best books ───────────────────── */
$catRes = $conn->query("
    SELECT c.id, c.name, COUNT(bb.book_id) AS book_count
    FROM   categories c
...
/* ── Fetch best books for active category ────────────────────── */
$books = [];
if ($activeCatId > 0) {
    $bStmt = $conn->prepare("
        SELECT b.id, b.title, b.img, b.price, b.authors, b.isbn, b.publishers, b.length
        FROM   books_data b
...
<head>
    ...
    <title>Best Books<?= !empty($activeCatName) ? ' — ' . htmlspecialchars($activeCatName, ENT_QUOTES) : '' ?> | Professional Publication Services</title>
    <link rel="icon" type="image/png" href="../uploads/logos/logotest.png">
...
<body>
    ...
    <div class="page-hero">
        <div class="hero-inner">
            ...
            <h1 class="hero-title">Best <em>Books</em></h1>
            <p class="hero-sub">
                <strong>
                    <?= number_format($totalBest) ?> handpicked titles
                </strong>
                across
                <?= count($categories) ?>
        ...
        <main class="books-main">
            ...
            <div class="section-bar reveal">
                <div class="section-bar-left">
                    <div class="section-eyebrow">Best Books</div>
            ...
            <?php if (empty($books)): ?>
                ...
                <div class="empty-state reveal">
                    ...
                    <p>No best books have been curated for this category yet.<br>Check back soon.</p>
                </div>
            ...
            <?php else: ?>
                ...
                <div class="books-grid" id="booksGrid">
                    <?php foreach ($books as $i => $book):
                        ...
                        ?>
                        <a href="bd.php?id=<?= (int) $book['id'] ?>" class="book-card reveal"
                ...
                <div class="books-list" id="booksList">
                    <?php foreach ($books as $i => $book):
                        ...
                        $hasImg = !empty($book['img']) && file_exists("../" . $book['img']);
                        ?>
                        <a href="bd.php?id=<?= (int) $book['id'] ?>" class="book-list-row reveal"
