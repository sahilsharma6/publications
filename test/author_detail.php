...
<head>
    ...
    <title><?= htmlspecialchars($author['name'], ENT_QUOTES) ?> | Author Profile | Professional Publication Services</title>
                        ...
                        <?php else: ?>
                            <div class="books-list">
                                <?php foreach ($books as $i => $book):
                                    ...
                                    ?>
                                    <a href="book_detail.php?id=<?= (int) $book['id'] ?>" class="book-row"
