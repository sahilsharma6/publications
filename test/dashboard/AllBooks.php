...
<head>
    ...
    <style>
        ...
        .book-card-actions a { color: var(--accent); }
        .book-card-actions button { color: var(--danger); border-left: 1px solid var(--gray-100); }
        .book-card-actions a:hover { background: var(--accent-light); }
        .book-card-actions button:hover { background: var(--danger-light); }
...
<body>
    ...
    <div class="main-card">
                ...
                <div class="toolbar-left">
                    ...
                    <div class="search-box">
                        ...
                        <input type="text" class="search-input" name="search"
                            ...
                            placeholder="Search title, ISBN, publisher…"
        ...
        <div class="filter-chips">
            ...
            <?php if ($catFilter > 0):
                $activeCatName = '';
                foreach ($allCats as $c) { if ((int)$c['id'] === $catFilter) { $activeCatName = $c['name']; break; } }
            ?>
                    ...
                    <div class="book-card" style="animation: fadeUp .3s <?= $i * 0.04 ?>s both">
                        ...
                        <div class="book-card-body">
                            ...
                            <?php if (!empty($book['publishers'])): ?>
                                <div style="font-size:11.5px;color:var(--gray-400);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                    <?= htmlspecialchars($book['publishers'], ENT_QUOTES) ?>
                                </div>
                            <?php endif; ?>
                            <div class="book-card-price <?= empty($book['price']) ? 'no-price' : '' ?>">
                                <?= !empty($book['price']) ? 'PKR ' . number_format((float)$book['price'], 2) : 'No price' ?>
                            </div>
                        </div>
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="<?= sortUrl('title') ?>">
                                    Book
                                    <i class='bx <?= $sort === 'title' ? ($dir === 'asc' ? 'bx-sort-up' : 'bx-sort-down') : 'bx-sort-alt-2' ?> sort-icon <?= $sort === 'title' ? 'active' : '' ?>'></i>
                                </a>
                            </th>
                            ...
                            <th style="width:130px">
                                <a href="<?= sortUrl('publishers') ?>">
                                    Publisher
                                    <i class='bx <?= $sort === 'publishers' ? ($dir === 'asc' ? 'bx-sort-up' : 'bx-sort-down') : 'bx-sort-alt-2' ?> sort-icon <?= $sort === 'publishers' ? 'active' : '' ?>'></i>
                                </a>
                            </th>
                            <th style="width:110px">
                                <a href="<?= sortUrl('price') ?>">
                                    Price
                                    <i class='bx <?= $sort === 'price' ? ($dir === 'asc' ? 'bx-sort-up' : 'bx-sort-down') : 'bx-sort-alt-2' ?> sort-icon <?= $sort === 'price' ? 'active' : '' ?>'></i>
                                </a>
                            </th>
                            ...
                            <tr style="animation: fadeUp .25s <?= $i * 0.03 ?>s both">
                                ...
                                <td>
                                    <div class="book-cell">
                                        ...
                                        <div class="book-cell-info">
                                            ...
                                            <div class="book-meta">
                                                <span class="book-isbn"><?= htmlspecialchars($book['isbn'], ENT_QUOTES) ?></span>
                                                <?php if (!empty($book['description'])): ?>
                                                    <span class="desc-excerpt"><?= htmlspecialchars(substr($book['description'], 0, 60), ENT_QUOTES) ?>…</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <span class="price-tag <?= empty($book['price']) ? 'no-price' : '' ?>">
                                        <?= !empty($book['price']) ? 'PKR ' . number_format((float)$book['price'], 2) : '—' ?>
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="row-actions" style="justify-content:center">
                                        <a href="EditBook.php?id=<?= (int)$book['id'] ?>" class="act-btn act-edit" title="Edit book">
                                            <i class='bx bx-edit-alt'></i>
                                        </a>
                                        <button class="act-btn act-delete"
                                                data-id="<?= (int)$book['id'] ?>"
                ...
                <?php if ($totalPages > 1): ?>
                    <ul class="pag-list">
                        ...
                        if ($pStart > 1): ?>
                            ...
                            <?php if ($pStart > 2): ?><li><span class="pag-ellipsis">…</span></li><?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if ($pEnd < $totalPages): ?>
                            <?php if ($pEnd < $totalPages - 1): ?><li><span class="pag-ellipsis">…</span></li><?php endif; ?>
